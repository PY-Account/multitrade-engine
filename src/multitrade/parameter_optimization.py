...
_SEARCH_SPACES: dict[str, dict[str, tuple[object, ...]]] = {
    ...
    "confirmed_breakout_retest_v4": {
        "resistance_lookback": (30, 45, 60),
        "confirmation_bars": (5,),
        "maximum_retest_bars": (12, 18, 24),
        "breakout_buffer": ("0", "0.001"),
        "acceptance_tolerance": ("0", "0.0015", "0.003"),
        "level_tolerance": ("0.006", "0.010", "0.015"),
        "volume_multiplier": ("0.90", "1.00", "1.10"),
        "maximum_pullback_volume_ratio": ("1.00", "1.15", "1.30"),
        "stop_atr_buffer": ("0.35", "0.50", "0.75"),
        "minimum_stop_atr": ("0.50", "0.75", "1.00"),
        "reward_multiple": ("2", "2.5", "3"),
    },
