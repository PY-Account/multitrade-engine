...
from multitrade.domain import RiskDecision, TradeIntent
    ...
    def process(self, intent: TradeIntent) -> EngineResult:
        ...
        if not self.enable_order_submission:
            ...
            self.audit_store.release(
                intent.intent_id, "paper_order_submission_disabled"
            )
