...
class StrategyExperimentProgramTests(TestCase):
    ...
    def test_repository_manifests_match_runtime_strategies(
        ...
        self.assertEqual(len(program.all_experiments), 35)
        self.assertEqual(
            len(
                {
        ...
        self.assertEqual(
            family_counts,
            {
                ...
                "structural_trend_retest": 3,
                "zero_dte_defined_risk_income": 1,
                "directional_fvg_options": 1,
                "index_defined_risk_put_credit": 1,
            },
        )
    ...
    def test_dashboard_payload_is_json_serializable(self) -> None:
        ...
        self.assertEqual(len(payload["experiments"]), 35)
